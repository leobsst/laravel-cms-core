...
<meta name="description" content="{{mb_strimwidth($page->seo->description ?: Setting::get('website_description'), 0, 150, '...')}}">
        ...
        <link rel="canonical" href="{{route('core.page.show', ['fallbackPlaceholder' => $page->full_path])}}">
        ...
        <meta property="og:url" content="{{route('core.page.show', ['fallbackPlaceholder' => $page->full_path])}}">
