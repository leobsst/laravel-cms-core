...
<meta name="description" content="{{mb_strimwidth($seo->description ?: Setting::get('website_description'), 0, 150, '...')}}">
        ...
        <link rel="canonical" href="{{route('core.core.page.show', ['theme' => $page->theme->name, 'slug' => $page->slug])}}">
        ...
        <meta property="og:url" content="{{route('core.core.page.show', ['theme' => $page->theme->name, 'slug' => $page->slug])}}">
