    ...
    <div
        ...
        <div class="bg-zinc-50 max-w-[30rem] h-fit rounded-md shadow-2xl p-4">
            ...
            <div class="ml-20 -mt-12">
                <p>
                    Notre site web utilise des cookies nous permettant de personnaliser votre contenu et d'analyser son trafic.
                </p>
                <p>
                    Acceptez-vous l'utilisation de ces cookies ?
                </p>
                <div class="flex flex-col md:flex-row md:justify-between mt-2">
                    <a href="{{route('core.pages.show', ['fallbackPlaceholder' => 'politique-de-confidentialite'])}}"
                    ...
                    <div class="flex mt-4 md:mt-0 justify-end">
                        <button
                            title="Accepter"
                            x-on:click="cookie_consent = true"
                            type="button"
                            class="text-white px-3 py-2 rounded-md hover-opacity mr-4 whitespace-nowrap"
                            style="background-color: {{Setting::get('primary_color')}}">
                            J'accepte
                        </button>
                        <button
                            title="Refuser"
                            x-on:click="cookie_consent = false"
                            type="button"
                            class="hover-opacity text-gray-700 whitespace-nowrap">
                            Je refuse
                        </button>
                    </div>
                </div>
